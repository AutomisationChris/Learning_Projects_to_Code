...
start = st.date_input("Startdatum", value=datetime.date(2024, 1, 1), min=datetime.date(1981, 26, 9)
end = st.date_input("Enddatum", value=datetime.date(2024, 12, 31), min=datetime.date(1981, 25, 9, max=datetime.date(current_dateTime) )
